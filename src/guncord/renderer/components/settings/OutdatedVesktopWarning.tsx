...
import { Button, Card, HeadingTertiary, Paragraph } from "@Guncord/types/components";
import { useAwaiter } from "@Guncord/types/utils";
...
export function OutdatedVesktopWarning() {
    ...
    return (
        <Card variant="warning" className={cl("updater-card")}>
            <HeadingTertiary>Your Guncord is outdated!</HeadingTertiary>
