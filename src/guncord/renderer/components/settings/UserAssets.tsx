...
import { BaseText, Button, FormSwitch } from "@Guncord/types/components";
import {
    Margins,
    ModalCloseButton,
    ModalContent,
...
import { showToast, useState } from "@Guncord/types/webpack/common";
        ...
        <section>
            ...
            <div className="vcd-user-assets-asset">
                <img
                    ...
                    src={`guncord://assets/${asset}?v=${version}`}
                    alt=""
