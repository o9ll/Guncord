...
import { BaseText } from "@Guncord/types/components";
import { React, useRef,useState } from "react";

import { cl } from "./Settings";

function detectSource(json: any): "equicord" | "vencord" | "guncord" | "unknown" {
    ...
    // Plugins spécifiques à Guncord
    if (pluginNames.some(p => ["GuncordHelper", "equicordHelper"].includes(p))) return "guncord";
...
function cleanForGuncord(json: any): any {
    ...
    // Supprimer les plugins propres à Equicord/Vencord qui n'existent pas dans Guncord
    ...
    async function processFile(file: File) {
        ...
        try {
            ...
            const sourceLabel =
                ...
                source === "guncord" ? "Guncord" : "inconnu";

            const cleaned = cleanForGuncord(json);
            ...
            setStatus("success");
            setMessage(`✅ Settings ${sourceLabel} importés avec succès ! Redémarre Guncord pour appliquer.`);
        } catch (err: any) {
            setStatus("error");
    ...
    return (
        <div className={cl("category")}>
            ...
            <BaseText size="sm" style={{ marginBottom: "12px", opacity: 0.7 }}>
                Drag & drop your Equicord or Vencord backup JSON file here to import your settings into Guncord.
                Plugin-specific settings that don't exist in Guncord will be automatically removed.
            </BaseText>
