...
import { useState } from "@Guncord/types/webpack/common";
    ...
    return (
        <>
            <VesktopSettingsSwitch
                ...
                description="Automatically start Guncord on computer start-up"
            ...
            <VesktopSettingsSwitch
                ...
                description={"Start Guncord minimized when starting with system"}
