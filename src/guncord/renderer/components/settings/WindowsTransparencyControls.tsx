...
import { Heading, Paragraph } from "@Guncord/types/components";
import { Margins } from "@Guncord/types/utils";
import { Select } from "@Guncord/types/webpack/common";
            ...
            <SimpleErrorBoundary>
                <Select
                    ...
                    options={[
                        ...
                        {
                            label: "Acrylic (blurs the window behind Guncord for a translucent background)",
                            value: "acrylic"
                        }
                    ]}
                    closeOnSelect={true}
