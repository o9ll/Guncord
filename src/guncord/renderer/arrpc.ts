...
import { Logger } from "@Guncord/types/utils";
import { findLazy, onceReady } from "@Guncord/types/webpack";
import {
    ...
    InviteActions,
    StreamerModeStore
} from "@Guncord/types/webpack/common";
import { IpcCommands } from "shared/IpcEvents";

import { onIpcCommand } from "./ipcCommands";

const logger = new Logger("GuncordRPC", "#5865f2");
