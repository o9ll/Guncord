...
function SearchIcon({ width = 20, height = 20 }: { width?: number; height?: number; }) {
    return (
        <svg className="nc-sway-icon" width={width} height={height} viewBox="0 0 24 24" fill="currentColor">
...
export default definePlugin({
    ...
    start() {
        addHeaderBarButton("guncord-voice-channel-search", () => <VCSHeaderButton />, 9);
    },
    stop() {
        removeHeaderBarButton("guncord-voice-channel-search");
        scanCache = null;
    },
});
