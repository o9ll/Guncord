...
const SilentTypingEnhancedIcon = ({ width = 24, height = 24 }: { width?: number; height?: number; }) => (
...
const SilentTypingEnhancedToggle: any = ({ isMainChat, channel }: any) => {
...
export default definePlugin({
    ...
    chatBarButton: {
        icon: SilentTypingEnhancedIcon as any,
        render: SilentTypingEnhancedToggle,
    },

    start() {
        const { location } = settings.store;
        if (location === "headerbar") {
            addHeaderBarButton("SilentTypingEnhanced", () => (
                <HeaderBarButton
                    icon={SilentTypingEnhancedIcon}
            ...
            addChannelToolbarButton("SilentTypingEnhanced", () => (
    ...
    stop() {
        removeChatBarButton("SilentTypingEnhanced");
        removeHeaderBarButton("SilentTypingEnhanced");
        removeChannelToolbarButton("SilentTypingEnhanced");
    },
});
