...
const TABS: TabDef[] = [
    ...
    },
    {
        ...
        description: "Sync Guncord settings across devices",
    },
    {
        id: "language",
        label: "Language",
        ...
        description: "Change Guncord's interface language",
    },
];

// ── Modal inner ───────────────────────────────────────────────────────────────

function GuncordModalInner({ onClose }: { onClose: () => void; }) {
    ...
    let TabContent = null;
    switch (activeTab) {
        case "guncord": TabContent = <VencordTab />; break;
...
function GuncordModal({ modalProps }: { modalProps: ModalProps; }) {
    return (
        <ModalRoot {...modalProps} size={ModalSize.LARGE} className="nc-modal-wrapper">
            <ModalContent className="nc-modal-modal-content">
                <ErrorBoundary message="Failed to render Guncord Settings modal.">
                    <GuncordModalInner onClose={modalProps.onClose} />
                </ErrorBoundary>
            </ModalContent>
        </ModalRoot>
    );
