...
const ENTRY_KEY = "guncord_client_diagnostics";
        ...
        <div className={cl("page")}>
            <div className={cl("toolbar")}>
                <div>
                    ...
                    <BaseText size="sm" color="text-muted">
                        {t("This page interprets the metrics and flags plugins that may make Guncord lag.")}
                    </BaseText>
                </div>
    ...
    return (
        <div className={cl("page")}>
            ...
            <div className={cl("guide-section")}>
                ...
                <BaseText size="sm" color="text-muted">
                    {t("The numbers are samples collected while you use Guncord. If a plugin is not used during collection, it may look light even if it does more work in other situations.")}
                </BaseText>
            </div>
