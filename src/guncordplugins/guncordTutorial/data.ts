...
export const TUTORIAL_SEEN_KEY = "GuncordTutorial_seen_v1";
export const TUTORIAL_LANGUAGE_KEY = "GuncordTutorial_language";
...
export const UI_COPY = {
    en: {
        ...
        english: "English",
        italian: "Italiano",
        reopenHint: "You can reopen this tutorial from the GuncordTutorial settings.",
    ...
    it: {
        ...
        english: "English",
        italian: "Italiano",
        reopenHint: "Puoi riaprire questo tutorial dalle impostazioni di GuncordTutorial.",
...
export const TUTORIAL_STEPS: TutorialStep[] = [
    {
        title: {
            en: "Welcome to Guncord",
            it: "Benvenuta in Guncord"
        },
        route: {
            en: "First startup",
            it: "Primo avvio"
    ...
    },
    {
        title: {
            en: "Guncord settings",
            it: "Impostazioni Guncord"
        },
        route: {
            en: "Settings > Guncord Settings",
            it: "Settings > Guncord Settings"
        },
        body: {
            en: "The Guncord section is the control room for the client. Start there when you want to change behavior or find a tool.",
            it: "La sezione Guncord è la sala comandi del client. Parti da lì quando vuoi cambiare comportamento o trovare uno strumento."
        },
        bullets: {
            en: [
                "Guncord contains general client settings.",
                "Plugins lists stock plugins, Equicord plugins, and userplugins.",
                "Themes, Updater, Changelog, and Backup each have their own page."
            ],
            it: [
                "Guncord contiene le impostazioni generali del client.",
    ...
    },
    {
        ...
        route: {
            en: "Settings > Guncord Settings > Plugins",
            it: "Settings > Guncord Settings > Plugins"
        },
        body: {
    ...
    },
    {
        ...
        body: {
            en: "If Guncord lags, freezes, or starts using too much memory, open Client Diagnostics before disabling random plugins.",
            it: "Se Guncord lagga, si blocca, o usa troppa memoria, apri Client Diagnostics prima di disattivare plugin a caso."
        },
        bullets: {
            en: [
        ...
        panel: "guncord_client_diagnostics_panel",
        actionLabel: {
            en: "Open Diagnostics",
            it: "Apri Diagnostics"
        }
    },
    {
        ...
        route: {
            en: "Settings > Guncord Settings > Themes",
            it: "Settings > Guncord Settings > Themes"
        },
        body: {
    ...
    },
    {
        ...
        panel: "guncord_stereo_installer_panel",
        actionLabel: {
    ...
    },
    {
        ...
        route: {
            en: "Settings > Guncord Settings > Updater",
            it: "Settings > Guncord Settings > Updater"
        },
        body: {
            en: "Updater checks for Guncord updates. Use it when a patch breaks, the client crashes, or you want the newest fixes.",
            it: "Updater controlla gli aggiornamenti di Guncord. Usalo quando una patch si rompe, il client crasha, o vuoi gli ultimi fix."
        },
        bullets: {
            en: [
    ...
    },
    {
        ...
        route: {
            en: "Settings > Guncord Settings > Changelog",
            it: "Settings > Guncord Settings > Changelog"
        },
        body: {
    ...
    },
    {
        ...
        route: {
            en: "Settings > Guncord Settings > Backup & Restore",
            it: "Settings > Guncord Settings > Backup & Restore"
        },
        body: {
