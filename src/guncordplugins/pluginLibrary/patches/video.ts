...
import { ProfilableStore, replaceObjectValuesIfExist, types, utils } from "@guncordplugins/pluginLibrary";
...
// real import (`@guncordplugins/betterScreenshare.desktop/stores`) once that plugin exists.
