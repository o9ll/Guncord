...
import { fakeD } from "@guncordplugins/fakeDeafen";
import { replacedUserPanelComponent } from "@guncordplugins/pluginLibrary/patches";
import definePlugin from "@utils/types";

export default definePlugin({
    name: "PluginLibrary",
    description: "A library for plugins.",
