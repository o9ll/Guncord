...
export const settings = definePluginSettings({
  ...
  minResultsForAPI: {
    type: OptionType.NUMBER,
    description: "Minimum number of results before using the API (0 = always use the API)",
    default: 5,
  },
  apiRequestDelay: {
    type: OptionType.NUMBER,
...
export default definePlugin({
  ...
  description: "Advanced search similar to Discord mobile - Searches in all conversations, private messages, images, etc.",
