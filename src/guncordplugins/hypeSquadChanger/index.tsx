...
function injectHypeSquadChangerIntoNativePanel() {
    ...
    if (editingPanel && !document.getElementById("guncord-hypesquad-changer-modal-container")) {
        const scroller = editingPanel.querySelector("[class*='content__523e1'], [class*='scroller_'], [class*='scrollRegion_'] > div");
        if (scroller) {
            const container = document.createElement("div");
            container.id = "guncord-hypesquad-changer-modal-container";
    ...
    if (settingsView && !document.getElementById("guncord-hypesquad-changer-container")) {
        ...
        if (isProfileTab) {
            ...
            if (contentColumn) {
                ...
                if (!targetParent.querySelector("#guncord-hypesquad-changer-container")) {
                    const container = document.createElement("div");
                    container.id = "guncord-hypesquad-changer-container";
