...
function UpdateBanner() {
    ...
    async function doUpdate() {
        ...
        try {
            ...
            setTimeout(() => {
                try {
                    VencordNative.guncord?.relaunch?.();
                } catch {
            ...
            console.error("[GuncordUpdater] Update error:", e);
    ...
    return React.createElement("div", {
        ...
        React.createElement("div", {
            ...
            React.createElement("span", { style: { fontWeight: 700, flexShrink: 0 } },
                `Guncord ${info.remoteVersion} available!`
            ),
...
function mountBanner() {
    if (bannerContainer || document.getElementById("guncord-updater-root")) return;

    waitFor(["createRoot", "render"], (ReactDOM: any) => {
        if (bannerContainer || document.getElementById("guncord-updater-root")) return;
        bannerContainer = document.createElement("div");
        bannerContainer.id = "guncord-updater-root";
        ...
        try {
            ...
            console.error("[GuncordUpdater] Error mounting banner:", e);
...
export default definePlugin({
    ...
    required: true,
    description: "Shows a banner when a new Guncord version is available. Click Update to install.",
