...
import { providers } from "@guncordplugins/musicControls/spotify/lyrics/api";
import { lyricsAlternative } from "@guncordplugins/musicControls/spotify/lyrics/providers/store";
