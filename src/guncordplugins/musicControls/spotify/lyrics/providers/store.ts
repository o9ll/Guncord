...
import { getLyrics, lyricFetchers, providers, updateLyrics } from "@guncordplugins/musicControls/spotify/lyrics/api";
import { SpotifyStore, type Track } from "@guncordplugins/musicControls/spotify/SpotifyStore";
