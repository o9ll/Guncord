...
import { getGroqKey } from "../guncordAI/groqManager";
...
async function transcribe(blob: Blob): Promise<string> {
    ...
    if (!apiKey) throw new Error(t("API key missing — Configure your key in Settings → GuncordAI"));
...
export default definePlugin({
    ...
    description: "Real-time voice dictation via Groq Whisper (free). API key shared with GuncordAI.",
    authors: [{ name: "User",
     id: 0n }],
