...
// through the cracks: window.__guncordPCLReset()
...
export default definePlugin({
    ...
    authors: [{ name: "arg0NNY (ported by Guncord)",
     id: 0n }],
    settings,
    ...
    async start() {
        ...
        (window as any).__guncordPCLReset = () => forceReset("manually triggered via window.__guncordPCLReset()");
    ...
    stop() {
        ...
        clearTimeout(autolockTimeout);
        clearTimeout(watchdogTimeout);
        delete (window as any).__guncordPCLReset;
