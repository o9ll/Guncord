...
export const enum IpcEvents {
    ...
    GET_INSTALLER_PREFS = "GuncordGetInstallerPrefs",
    ...
    SET_WINDOW_BACKGROUND_MATERIAL = "GuncordSetWindowBackgroundMaterial",
    ...
    // Guncord Updater — Download an exe from a URL and launch it
    GUNCORD_DOWNLOAD_AND_RUN = "GuncordDownloadAndRun",
