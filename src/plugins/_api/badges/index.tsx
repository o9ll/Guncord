...
async function loadAllBadges(noCache = false) {
    ...
    const guncordBadges = await loadBadges(`https://raw.githubusercontent.com/o9ll/Guncord/refs/heads/main/assets/badges.json`, noCache).catch(() => ({}));

    DonorBadges = vencordBadges;
    EquicordDonorBadges = equicordBadges;
    GuncordBadges = guncordBadges;
}
