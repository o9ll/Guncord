...
$OUT = "C:\Users\o9\Documents\Githubb\guncord\release\win-unpacked"
$RES = "$OUT\resources"

Write-Host "=== ETAPE 1 : Build ===" -ForegroundColor Cyan
Set-Location "C:\Users\o9\Documents\Githubb\guncord"
...
Write-Host "Fichier : release\Guncord-1.14.5-portable.exe" -ForegroundColor Green
