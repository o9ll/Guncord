...
export const gitHash = process.env.GUNCORD_HASH || execSync("git rev-parse HEAD", { encoding: "utf-8" }).trim();
...
export const globPlugins = kind => ({
    ...
    setup: build => {
        ...
        build.onLoad({ filter, namespace: "import-plugins" }, async () => {
            ...
            // ─── External User Plugins (~/Documents/Guncord/userplugins/) ───────────
            // Scan and auto-create the external userplugins directory.
            const externalUserPluginsDir = join(homedir(), "Documents", "Guncord", "userplugins");
            try {
...
export const gitRemotePlugin = {
    ...
    setup: build => {
        ...
        build.onLoad({ filter, namespace: "git-remote" }, async () => {
            let remote = process.env.GUNCORD_REMOTE;
            if (!remote) {
...
export const commonOpts = {
    ...
    alias: {
        ...
        "@Guncord/types/components": "./src/components",
        "@Guncord/types/api": "./src/api",
        "@Guncord/types/plugins": "./src/plugins",
        "@Guncord/types": "./src",
