/*
 * Guncord, a desktop app aiming to give you a snappier Discord Experience
 * Copyright (c) 2026 o9
...
await Promise.all([
    ...
    createContext({
        ...NodeCommonOpts,
        entryPoints: ["src/guncord/main/index.ts"],
    ...
    createContext({
        ...NodeCommonOpts,
        entryPoints: ["src/guncord/preload/index.ts"],
        outfile: "dist/js/preload.js",
        footer: { js: "//# sourceURL=VesktopPreload" }
    }),
    createContext({
        ...NodeCommonOpts,
        entryPoints: ["src/guncord/preload/splash.ts"],
        outfile: "dist/js/splashPreload.js",
        footer: { js: "//# sourceURL=VesktopSplashPreload" }
    }),
    createContext({
        ...NodeCommonOpts,
        entryPoints: ["src/guncord/preload/updater.ts"],
    ...
    createContext({
        ...CommonOpts,
        globalName: "Equibop",
        entryPoints: ["src/guncord/renderer/index.ts"],
        outfile: "dist/js/renderer.js",
        format: "iife",
        inject: ["./scripts/build/injectReact.mjs"],
        jsxFactory: "VencordCreateElement",
        jsxFragment: "VencordFragment",
        external: ["@Guncord/types/*", "@guncord/types/*"],
        plugins: [vencordDep, includeDirPlugin("patches", "src/guncord/renderer/patches")],
