...
`;
    ...
    writeFileSync("src/guncordplugins/autoTranslateGuncord/index.ts", fileHeader + entriesStr + fileFooter, "utf8");
    console.log("Done! Written all translations to autoTranslateGuncord/index.ts.");
}
