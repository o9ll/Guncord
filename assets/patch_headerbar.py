...
with open(r"C:\Users\o9\Documents\Githubb\guncord\src\api\HeaderBar.tsx", "r", encoding="utf-8") as f:
    content = f.read()
...
function CompactHeaderBarToggle() {
    ...
    return (
        <HeaderBarButton
            ...
            tooltip="Compact Mode — Click to expand Guncord buttons"
...
with open(r"C:\Users\o9\Documents\Githubb\guncord\src\api\HeaderBar.tsx", "w", encoding="utf-8") as f:
    f.write(content)
