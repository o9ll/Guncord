...
const LS_KEY_ENABLED = "GuncordCP_enabled";
const DS_ALL_DATA = "customProfile_allData";
const DS_ALL_ENABLED = "customProfile_allEnabled";
const LS_ALL_DATA = "GuncordCP_allData";
const LS_ALL_ENABLED = "GuncordCP_allEnabled";
...
function CustomProfileModal({ rootProps }: { rootProps: any; }) {
    ...
    const accounts = React.useMemo(() => {
        ...
        const me = UserStore.getCurrentUser();
        // For debug: if only one account is found, we still simulate to see if the bar shows
        ...
        <ModalRoot {...rootProps} size="medium">
            ...
            <ModalContent className="cp-content">
                <Toggle
                    ...
                    sublabel={t("Lets other Guncord users see your Custom Profile, and lets you see theirs")}
                ...
                <div style={{
                    ...
                    <span style={{ color: "var(--text-warning, #faa61a)", fontSize: 13, lineHeight: 1.4 }}>
                        {t("This requires Discord authorization. Once enabled, everyone using Guncord will be able to see your Custom Profile, and you will be able to see theirs.")}
                    </span>
                </div>
    ...
    hookUserProfile(profile: any) {
        ...
        try {
            ...
            if (isEnabled && (storedData.nitro || storedData.badgeFlags != null)) {
                ...
                // Ensure original badges are overwritten in the profile
